...
<div v-else class="stm_lms_expired_notice__wrapper">
	<div class="stm_lms_expired_notice warning_expired">
		...
		<template v-else-if="course.membership_expired">
			<?php esc_html_e( 'Subscription has expired', 'masterstudy-lms-learning-management-system' ); ?>
		</template>
		<template v-else-if="course.membership_inactive">
			<?php esc_html_e( 'Subscription is not active', 'masterstudy-lms-learning-management-system' ); ?>
		</template>
	</div>
</div>
